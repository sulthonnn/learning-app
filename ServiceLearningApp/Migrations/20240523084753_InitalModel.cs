        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkChapterId = table.Column<int>(type: "integer", nullable: false),
                    FkImageId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubChapters_Chapters_FkChapterId",
                        column: x => x.FkChapterId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkExerciseId = table.Column<int>(type: "integer", nullable: false),
                    FkUserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseTransactions_AspNetUsers_FkUserId",
                        column: x => x.FkUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Options_Questions_FkQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseTransactions_FkUserId",
                table: "ExerciseTransactions",
                column: "FkUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_FkImageId",
                table: "Questions",
                column: "FkImageId");

            migrationBuilder.CreateIndex(
                name: "IX_SubChapters_FkChapterId",
                table: "SubChapters",
                column: "FkChapterId");
