...
namespace ServiceLearningApp.Migrations
{
    ...
    [Migration("20240710180708_MakeMandatoryFkUploadId")]
    partial class MakeMandatoryFkUploadId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceLearningApp.Model.HistoryAnswer", b =>
                {
                    ...
                    b.Property<int>("FkExerciseTransactionId")
                        .HasColumnType("integer");

                    b.Property<int>("FkOptionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("FkExerciseTransactionId");

                    b.HasIndex("FkOptionId");
            ...
            modelBuilder.Entity("ServiceLearningApp.Model.HistoryAnswer", b =>
                {
                    b.HasOne("ServiceLearningApp.Model.ExerciseTransaction", "ExerciseTransaction")
                        .WithMany("HistoryAnswer")
                        .HasForeignKey("FkExerciseTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServiceLearningApp.Model.Option", "Option")
                        .WithMany()
                        .HasForeignKey("FkOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ExerciseTransaction");
